...
# variables
#path_to_all_images = r"H:\Building_Footprint_Extraction\Project_Files\Combined_data_set"
path_to_all_images = r'H:\Multi-Spectral-Satelite-Image-Classification\Dataset\10_bands_5_classes'

#path_to_split_datasets = "H:\Building_Footprint_Extraction\Project_Files\processed_data"
path_to_split_datasets = r'Dataset\ProcessedData10bands5classes'

# percentage of validation data (between 0 an 1)
percentage_validation = 0.10
